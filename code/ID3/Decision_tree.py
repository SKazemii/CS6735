...
tbl_dir = os.path.join(project_dir, "manuscript", "src", "tables", "programing_project")
...
print("--------- first dataset 'canc' --------------")
print("------------------- DT -----------------------")
scores_2 = evaluate_algorithm(
    dataset, decision_tree, n_folds, max_depth, min_size, split_parameter
)
