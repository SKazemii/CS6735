...
a = "Accuracy Naive Bayes on cancer dataset"
canc = (
    pd.read_csv(
...
acc1.append(np.average(acc))
acc1.append(np.std(acc))
a = "Accuracy Naive Bayes on mushroom dataset"
...
acc1.append(np.average(acc))
acc1.append(np.std(acc))
a = "Accuracy Naive Bayes on cars dataset"
...
acc1.append(np.average(acc))
acc1.append(np.std(acc))
a = "Accuracy Naive Bayes on ecol dataset"
...
acc1.append(np.average(acc))
acc1.append(np.std(acc))
a = "Accuracy Naive Bayes on letter dataset"
