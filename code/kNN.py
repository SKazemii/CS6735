...
a = "Accuracy KNN on cancer dataset"
canc = (
    pd.read_csv(
...
acc = list()
for _ in range(10):
    knn = KNN(n_folds=5, dataset=dataset, k_neighbor=5)
    accuracy = knn.fit()
...
acc1.append(np.average(acc))
acc1.append(np.std(acc))
a = "Accuracy KNN on cars dataset"
...
acc1.append(np.average(acc))
acc1.append(np.std(acc))
a = "Accuracy KNN on ecol dataset"
...
acc1.append(np.average(acc))
acc1.append(np.std(acc))
a = "Accuracy KNN on letter dataset"
...
acc1.append(np.average(acc))
acc1.append(np.std(acc))
a = "Accuracy KNN on mushroom dataset"
