...
Before describing the dataset, let look at the algorithms and what kind of data is proper.
...
The size of the dataset is 20000 $\times$ 16. The first column also shows the class of sample that is a capital letter. This dataset has no missing values. In addition, all classes are replaced with a numerical value as a pre-processing step.
