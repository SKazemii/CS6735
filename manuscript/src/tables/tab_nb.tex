...
\multicolumn{2}{|r}{naivebayes(trainset, testset) } & \multicolumn{2}{l|}{compute the distants} \\
\multicolumn{2}{|r}{predict(models, test\_row) } & \multicolumn{2}{l|}{compute the distants} \\
\multicolumn{2}{|r}{model\_classes(dataset) } & \multicolumn{2}{l|}{compute the distants} \\
\multicolumn{2}{|r}{find\_pdf(x, mean, stdev) } & \multicolumn{2}{l|}{compute the distants} \\ \midrule
